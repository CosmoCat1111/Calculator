...
const Calculator = {
    ...
    Display_Value: '0',
    //This will hodl the first operand for any expressions, we set it null for now.
    First_Operand: null,
...
keys.addEventListener('click', (event) => {
    ...
    //ensures that ac clears all inpurts from the calculator screen.
